...
public class PacienteNino extends Paciente{
     ...
     * @param fechaIngreso
     */
    public PacienteNino(String nombre, String apellido, String dni , modelo.util.Domicilio domicilio, String telefono, String nroHistoriaMedica, LocalDate fechaIngreso){
